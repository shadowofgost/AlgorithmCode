...
def test_insert_sort_single(initial):

def test_insert_sort(initial_list):
    insert_sort_list = deepcopy(initial_list)
    for i in insert_sort_list:
        pass


def test_merge_sort_(initial_list):
...
def run():
    ...
    begin = time()
    insert_sort_list_result = insert_sort(insert_sort_initial_list)
    end = time()
    print(end-begin)
    print(insert_sort_list_result)
    begin = time()
    merge_sort_list_result = merge_sort(merge_sort_initial_list)
    end = time()
    print(end-begin)
